<template>
	<view class="container">
		<view class="list-cell b-b m-t" @click="navTo('个人资料')" hover-class="cell-hover" :hover-stay-time="50">
			...
			<text class="cell-more iconfont iconjiantou"></text>
		</view>
		...
		<!-- #ifdef APP-PLUS -->
		<view class="list-cell" @click="navSet('/pages/set-password/set-password')" hover-class="cell-hover" :hover-stay-time="50">
			<text class="cell-tit">密码设置</text>
			<text class="cell-more iconfont iconjiantou"></text>
		</view>
		<!-- #endif -->
